...
import com.ultikits.plugins.menu.i18n.UltiMenuLanguageCatalogueTest.Catalogue;
 ...
 * ({@link UltiMenuLanguageCatalogueTest#loadModuleCatalogues()}: the framework's own {@link Language},
...
public final class CatalogueText {
    ...
    public static Map<String, String> entries(String code) {
        try {
            for (Catalogue c : UltiMenuLanguageCatalogueTest.loadModuleCatalogues()) {
